  ...
  return (
    ...
    >
      <div className="container mx-auto px-6">
        ...
        <div className="bg-white text-black p-8 rounded-lg shadow-lg mb-12 max-w-8xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="bg-[#00abf1] text-black p-8 rounded-lg shadow-lg flex flex-col items-center text-center border-black border">
              <h3 className="text-2xl text-left font-black text-white mb-8">
                Flagship Initiative
              </h3>
            ...
            <div className="bg-[#ff6521] text-black p-8 rounded-lg shadow-lg flex flex-col items-center text-center border-black border">
              <h3 className="text-2xl text-left font-black text-white mb-8">
            ...
            <div className="bg-black text-black p-8 rounded-lg shadow-lg flex flex-col items-center text-center border-black border">
              <h3 className="text-2xl text-left font-black text-white mb-8">
            ...
            <div className="bg-[#0070e3] text-black p-8 rounded-lg shadow-lg flex flex-col items-center text-center border-black border]">
              <h3 className="text-2xl text-left font-black text-white mb-8">

...
import i7 from "./assets/isco-caves/i7.jpg";
import i8 from "./assets/isco-caves/i8.jpg";
...
export const stories = [
  ...
  {
    id: 4,
    title: "Isco Cave Rock Paintings",
    url: "/story4",
    description:
    ...
    imageUrl: bg_isco,
    videoUrl: "https://www.youtube.com/watch?v=dQw4w9WgXcQ",
    imageUrls: [i0, i1, i2, i3, i4, i5, i6, i7, i8, i9, i10],
  },
  {
    id: 5,
    title: "Bah",
    url: "/story5",
    description:
      "Hi, I’m Story 5, a passionate photographer and videographer with a love for capturing the beauty of the world.",
    imageUrl:
